...
$.smallBox = function(a, b) {
    ...
    var $lastSmallBox = $('#divSmallBoxes .SmallBox').last();
    var $firstSmallBox = $('#divSmallBoxes .SmallBox').first();
    var h=window.innerHeight|| document.documentElement.clientHeight|| document.body.clientHeight;
    if($lastSmallBox.css('top') != undefined){
        var lasttop = $lastSmallBox.css('top');
        lasttop = lasttop.substring(0,lasttop.length-2);
        console.log(lasttop);
    	if(parseInt(lasttop) >= (h-120)){
    		$firstSmallBox.remove();
    	}
    }
    SmallBoxes += 1,
    c = "";
